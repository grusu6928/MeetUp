...
//    Map<Starter, List<Looker>> groups = graph.runAlgorithm();
//
...
//    Map<Looker, Integer> lookerCount = new HashMap<>();
//
//    for (List<Looker> list : groups.values()) {
...
//  }
//
//  private Looker generateLooker(int id) {
...
//    double latitude = this.getRandomDouble(null, 40, 43, 10);
//    double longitude = this.getRandomDouble(null, -73, -69, 10);
//    return new Looker(id, username, event, startTime, endTime, latitude, longitude);
//  }
//
//  private Starter generateStarter(int id) {
//    int stringLen = ThreadLocalRandom.current().nextInt(0, 20);
//    String username = this.generateName(stringLen);
//    String event = this.generateEvent();
//    String startTime = this.generateStartTime();
...
//
//    return new Starter(id, username, event, startTime, endTime, latitude, longitude, capacity);
//  }
//
...
//  }
//
//  // Source: https://stackoverflow.com/questions/4143304/how-do-you-generate-a-random-number-with-decimal-places
//  public double getRandomDouble(final Random random,
